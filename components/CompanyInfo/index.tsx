  ...
  return (
    <div className="w-[1260px] h-[763px] bg-[#0860C6] px-[36px] py-[76px]">
      ...
      <p className="text-[#FFFFFF] mt-7 font-[Roboto] text-base font-semibold w-[643px] h-[169px] leading-[25.5px] tracking-[0.16px]">
        ...
        erat volutpat. Donec condimentum libero ut consequat elementum. Vivamus
        vehicula porttitor est ut congue. Aenean varius aliquam auctor. Integer
        sed mattis sapien. Praesent vestibulum blandit eros, id lacinia lacus
        porttitor at. Proin velit urna, vestibulum et urna nec, luctus posuere
        magna. Nunc ac commodo nulla.
      </p>
      ...
      <div>
        <Image
          ...
          height={24}
        />
        <p >Dirección: Prol. 16 de Septiembre Manzana 008, Lazaro Cardenas, 53560 Naucalpan de Juárez, Méx.</p>
      </div>
      <div className="pt-7">
      <Image
          className="absolute ml-[-40px]"
