...
const ProductName: React.FunctionComponent = () => {
  return (
    <div className="flex md:gap-[43px] gap-3">
      <div>
        ...
        <div className="mt-3 font-[DM Sans] text-lg font-medium leading-normal text-[#576D99]">Product name</div>
        <div className="font-[DM Sans] text-lg font-medium leading-normal text-[#1e1e1e80]">$60.00 - $120.00</div>
      </div>
      <div>
